...
class Scene(object):
    ...
    def enter(self):
        ...
        print("Subclass it and impoement enter().")
        exit(1)
    ...
    def enter(self):
        ...
        if action == "shoot!":
            print(dedent("""
                ...
                and blash you repeatedly in the face until you are
...
class TheBridge(Scene):
    ...
    def enter(self):
        print(dedent("""
            You burst onto the Bridge with the neutron desrtuct bomb
            under your arm and surprise 5 Gothons who are tryong to
        ...
        if action == "throw the bomb":
            ...
            print(dedent("""
                ...
                You in inch backward to the door .
                """))
